...
class config:
    ...
    def __init__(self, path: str) -> None:
        try:
            ...
            if not os.path.exists(path=self.path):
                ...
                data = {
                    ...
                    "system": {
                        ...
                        "seasongroup": ["纸房子|62ed7ac87d5504007e4ab046"],
                    },
                }
            ...
            self.__config_check__(
                self.apidata["nastools"], "host", "http://127.0.0.1:3000"
            )
            self.__config_check__(self.apidata["nastools"], "authorization", "")
            ...
            self.__config_check__(
                self.apidata["jellyfin"], "host", "http://127.0.0.1:8096"
            )
            ...
            self.__config_check__(
                self.apidata["douban"], "key", "0ac44ae016490db2204ce0a042db2916"
            )
            ...
            self.__config_check__(
                self.systemdata, "seasongroup", ["纸房子|5eb730dfca7ec6001f7beb51"]
            )
